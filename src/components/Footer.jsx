        ...
        <footer className="relative bg-gray-900/90 text-gray-300">
            <div className="max-w-7xl mx-auto px-6 py-14">
                <div className="grid md:grid-cols-3 gap-10">
                    <div>
                        <NavLink to="/" className="text-2xl font-bold text-indigo-400">
                            Infinity<span className="text-white">Technologies</span>
                        </NavLink>
                        ...
                        <div className="flex gap-4 mt-6">
                            <NavLink to="https://github.com/mrsuraj24"
                                target="_blank"
                                rel="noreferrer"
                            ...
                            <NavLink
                                to="https://www.linkedin.com/in/surajv24/"
                                target="_blank"
                                rel="noreferrer"
                                className="p-2 rounded-full bg-gray-800 hover:bg-indigo-600 transition">
                                <FaLinkedin size={18} />
                ...
                <div className="border-t border-gray-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
                    <p>© {new Date().getFullYear()} Infinity Technologies. All rights reserved.</p>
                </div>
            </div>
            <button onClick={scrollToTop} className="fixed bottom-7 right-6 bg-indigo-500 text-white p-3 rounded-full hover:scale-105 shadow-lg hover:bg-indigo-700 transition" aria-label="Scroll to top">
                <FaArrowUp size={17} />
            </button>
            <WhatsApp />
        </footer>
